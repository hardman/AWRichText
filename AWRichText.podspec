#
#  Be sure to run `pod spec lint AWRichText.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = "wanghongyu"
  # Or just: s.author    = "wanghongyu"
  # s.authors            = { "wanghongyu" => "wanghongyu@airwind.cn" }
  # s.social_media_url   = "http://twitter.com/wanghongyu"
